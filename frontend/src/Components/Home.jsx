...
const Home = () => {
  ...
  />
          ...
          <div  style={{paddingLeft:"18%",paddingRight:"18%"}}><p style={{ color: 'black' ,textAlign: 'center'}}>
...
Explore our event calendar today and be part of the exciting experiences waiting for you!</p></div>
